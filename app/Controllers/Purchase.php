...
class Purchase extends BaseController
{
        ...
        else
        {
            if($vatable=="VAT INC")
            {
                $values = [
                    ...
                    'Price'=>$unitPrice,'Currency'=>'PHP','ContactPerson'=>$contactPerson,'ContactNumber'=>$phone,'EmailAddress'=>$email,
                    'Address'=>$address,'Terms'=>$terms,'Warranty'=>$warranty,
            ...
            else if($vatable=="VAT EX")
            {
                $values = [
                    'OrderNo'=>$orderNo, 'orderID'=>$item,'Supplier'=>$supplier,
                    'Price'=>$unitPrice*1.12,'Currency'=>'PHP','ContactPerson'=>$contactPerson,'ContactNumber'=>$phone,'EmailAddress'=>$email,
                    'Address'=>$address,'Terms'=>$terms,'Warranty'=>$warranty,
                    'Reference'=>'','Remarks'=>'','Vatable'=>$vatable,'purchaseLogID'=>0
                ];
                $canvassModel->save($values);
            ...
            else
            {
                $values = [
                    ...
                    'contactPerson'=>$contactPerson,'EmailAddress'=>$email,'contactNumber'=>$phone,
                    'industryID'=>0,
                ];
        ...
        else
        {
            if($vatable=="VAT INC")
            {
                ...
                foreach($unitPrice as $key => $value) 
                {
                    ...
                    'Currency'=>$currency,'ContactPerson'=>$contactPerson,'ContactNumber'=>$phone,'EmailAddress'=>$email,'Address'=>$address,
    ...
    public function sendEmail()
    {
        ...
        <p>I am writing to place an order for the items listed in the attached document. Please review the attached file for details on the products we wish to order, including quantities and any specific requirements.</p>
        <p><i>Please see attachment</i></p>
        <p>Could you please confirm receipt of this order and provide an estimated delivery date? Additionally, kindly send us a pro forma invoice based on the attached order details.</p>
        </br>
        <p>If you have any questions or need further information, please do not hesitate to contact me.</p>
        <p>Thank you for your assistance. I look forward to your confirmation.</p>
        <p>Best regards,</p>
        <p>APFC</p>
        ";
        ...
        $builder->join('tblpurchase_review d','d.purchaseNumber=a.purchaseNumber','LEFT');
        $builder->join('tblaccount e','e.accountID=d.accountID','LEFT');
        $builder->WHERE('a.purchaseNumber',$code);
        $data = $builder->get(); 
        $template = '';  
        //general services
        ...
        {        
            ...
            <body>
                ...
                <tr>
                    ...
                    <td><center><h1>PURCHASE ORDER</h1></center></td>
        ...
        $email->attach($po, 'attachment', $code.".pdf", 'application/pdf');
