...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>FastCat WMS - PRF Report</title>
					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a href="<?=site_url('prf-report')?>" class="active">PRF Report</a></li>
							</ul>
							<?php } ?>
						</li>
						<li>
			...
			<div class="xs-pd-20-10 pd-ltr-20">
                <div class="row g-1">
                    <div class="col-lg-12 form-group">
                        <div class="card-box">
                            <div class="card-header"><i class="micon dw dw-bar-chart-1"></i>&nbsp;PRF Report</div>
                            <div class="card-body">
