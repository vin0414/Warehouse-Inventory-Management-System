...
$routes->get('first-approver/(:any)','purchaseOrderResource::firstApprover/$1');
//dashboard
...
$routes->get('moderate-level','Dashboard::moderatePRF');
$routes->get('low-level','Dashboard::lowPRF');
...
$routes->post('hold-request','Purchase::holdRequest');
...
$routes->post('close-purchase-order','Purchase::closePurchaseOrder');
$routes->post('cancel-purchase-order','Purchase::cancelPO');
...
$routes->get('load-request','Purchase::loadRequest');
$routes->get('search-request','Purchase::searchRequest');
$routes->get('load-order','Purchase::loadOrder');
$routes->get('search-order','Purchase::searchOrder');
$routes->get('load-purchase','Purchase::loadPurchase');
...
$routes->group('',['filter'=>'AuthCheck'],function($routes)
{
    ...
    $routes->get('/comply/(:any)','Home::complyPurchase/$1');
